      ...
      <div className="about__goal">
        <div className="about__goal-inner">
          ...
          <p className={"about__desc"}>
            ...
            зобов&rsquo;язання працювати на максимум для досягнення перемоги України
            та повернення окупованих територій. Наша організація зосереджена на
            гуманітарній допомозі біженцям і підтримці Збройних Сил України. Ми
            забезпечуємо необхідні ресурси, спрямовані на вирішення нагальних
            потреб. Наш фонд – це теплі серця людей, які об&rsquo;єднують зусилля для
