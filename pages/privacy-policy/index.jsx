  ...
  return (
    <div className="privacy-policy-page">
      ...
      <p>
        ...
        сайту, і ми не використовуємо файли cookie або інші механізми
        відстеження.
      </p>
      <p>
      ...
      <p>
        Ми можемо час від часу оновлювати цю політику конфіденційності. Усі
        зміни будуть опубліковані на цій сторінці, і дата останнього оновлення
        буде змінена.
      </p>
    </div>
  );
